                ...
                <div className="space-y-3">
                        ...
                        <div className="mt-1 flex items-center justify-between text-sm">
                            <div className="flex items-center gap-1">
                                ...
                                <Button
                                    ...
                                    className="h-5 w-5"
                                    onClick={() =>
                                        setIsViewingStartBreakdown(true)
                                    }
                                >
                    ...
                    >
                        <DialogContent>
                            ...
                            <DialogDescription>
                                Read-only cash distribution at the start of the
                                shift.
                            </DialogDescription>
                    ...
                    >
                        <DialogContent>
                            ...
                            <DialogDescription>
                                Read-only cash distribution at the end of the
                                shift.
                            </DialogDescription>
                            <div className="mt-4 grid grid-cols-1 gap-3 p-1">
                                {denominationConfig.map((d) => (
