...
import { store as storeProductRoute } from '@/routes/backstage/sellables/products';
...
export default function CreateProduct({ users }: { users: { id: string; name: string }[] }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        hide_until_sale: false,
        unlimited_quantity: true,
        quantity: '',
        unlimited_quantity_with_membership: true,
        quantity_with_membership: '',
        unlimited_quantity_without_membership: true,
    ...
    const [stockType, setStockType] = useState<'simple' | 'split' | 'variants'>('simple');
    ...
    const submit = (e: React.FormEvent) => {
        ...
        router.post(storeProductRoute().url, {
            ...data,
                ...
                <div className="w-full p-6 max-w-5xl mx-auto">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        <div>
                            ...
                            <p className="text-sm text-zinc-500">Enter the details for the new product.</p>
                        </div>
                    </div>
