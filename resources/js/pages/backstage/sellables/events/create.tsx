...
export default function CreateEvent({ users }: { users: { id: string; name: string }[] }) {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        router.post(storeEventRoute().url, {
            ...data,
                ...
                <div className="w-full p-6 max-w-5xl mx-auto">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        <div>
                            ...
                            <p className="text-sm text-zinc-500">Enter the details for the new event.</p>
                        </div>
                    </div>
