...
import { Collapsible, CollapsibleTrigger, CollapsibleContent } from '@backstage/components/ui/collapsible';
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger } from '@backstage/components/ui/dialog';
