...
import { ItemFormDialogBase } from '@backstage/components/inventory/item-form-dialog-base';
import type { ItemFormState } from '@backstage/components/inventory/item-form-dialog-base';
