...
export default function FullDataDialog({
    title = 'Full Data Source',
    triggerLabel = 'Manage',
    fields,
    sampleData,
}: Props) {
                            ...
                            <div className="flex h-full max-h-[75vh] flex-col overflow-y-auto rounded-md border bg-background p-4">
                                <div className="flex-shrink-0">
                                    ...
                                    <p className="mt-1 text-xs text-muted-foreground">
                                        Summary of destination domains and
                                        potential typos
                                    </p>
                                </div>
                                ...
                                <div className="mt-3">
                                    {(() => {
                                        ...
                                        const emails: string[] = sampleData
                                            .map((s) =>
                                                String(
                                                    s[emailField] ?? '',
                                                ).trim(),
                                            ...
                                            .filter(Boolean);
                                        const domains: string[] = emails.map(
                                            (e) =>
                                                e.includes('@')
                                                    ? e
                                                          .split('@')[1]
