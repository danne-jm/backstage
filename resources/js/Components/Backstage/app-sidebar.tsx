import { NavFooter } from '@/Components/Backstage/nav-footer';
import { NavMain } from '@/Components/Backstage/nav-main';
import { NavUser } from '@/Components/Backstage/nav-user';
import {
    Sidebar,
    SidebarContent,
    SidebarFooter,
