...
<body>
    <div class="container">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td rowspan="2" class="reference-section" style="vertical-align: top; width: 40%;">
                                ...
                                <div class="reference-code-inner">{{ $sale->reference_id }}</div>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="btn-container">
            <a href="{{ config('app.store_url') }}/confirmation?bag={{ $transaction->reference_id }}" class="btn">View Order</a>
        </div>
        ...
        <div class="footer">
            <div class="social-links">
                @if(env('LINKTREE_URL'))
                    <a href="{{ env('LINKTREE_URL') }}" class="social-link">
                         <img src="{{ config('app.store_url') }}/images/social/linktree.png" alt="Linktree" class="social-icon">
                    </a>
                @endif
                @if(env('FACEBOOK_URL'))
                    <a href="{{ env('FACEBOOK_URL') }}" class="social-link">
                        <img src="{{ config('app.store_url') }}/images/social/facebook.png" alt="Facebook" class="social-icon">
                    </a>
                @endif
                @if(env('WEBSITE_URL'))
                    <a href="{{ env('WEBSITE_URL') }}" class="social-link">
                        <img src="{{ config('app.store_url') }}/images/social/website.png" alt="Website" class="social-icon">
                    </a>
                @endif
                @if(env('TIKTOK_URL'))
                    <a href="{{ env('TIKTOK_URL') }}" class="social-link">
                        <img src="{{ config('app.store_url') }}/images/social/tiktok.png" alt="TikTok" class="social-icon">
                    </a>
                @endif
                @if(env('INSTAGRAM_URL'))
                    <a href="{{ env('INSTAGRAM_URL') }}" class="social-link">
                        <img src="{{ config('app.store_url') }}/images/social/instagram.png" alt="Instagram" class="social-icon">
                    </a>
                @endif
            </div>
            <p class="copyright">&copy; {{ date('Y') }} {{ env('COPYRIGHT', 'ESN Leuven - All rights reserved.') }}</p>
        </div>
    </div>
</body>
</html>
