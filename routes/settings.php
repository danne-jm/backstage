...
Route::middleware('auth')->group(function () {
    ...
    Route::post('settings/google/disconnect', [\App\Http\Controllers\GmailOAuthController::class, 'disconnect'])
    ...
    Route::middleware('permission:view_settings_users')->group(function () {
        ...
        Route::patch('settings/users/{id}', [\App\Http\Controllers\Settings\UserManagementController::class, 'update'])
            ->name('settings.users.update')
            ->middleware('permission:update_user');
        Route::delete('settings/users/{id}', [\App\Http\Controllers\Settings\UserManagementController::class, 'destroy'])
