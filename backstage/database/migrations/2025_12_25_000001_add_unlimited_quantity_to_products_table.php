...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Set unlimited flags where quantity == -1 and clear the -1 value to NULL
        \DB::table('products')->where('quantity', -1)->update(['unlimited_quantity' => true, 'quantity' => null]);
        \DB::table('products')->where('quantity_with_card', -1)->update(['unlimited_quantity_with_card' => true, 'quantity_with_card' => null]);
        \DB::table('products')->where('quantity_without_card', -1)->update(['unlimited_quantity_without_card' => true, 'quantity_without_card' => null]);
    }
