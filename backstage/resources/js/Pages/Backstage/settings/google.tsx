...
export default function GoogleSettings() {
    ...
    const providerEmail: string | undefined =
        (auth?.user?.gmail_provider_email as unknown as string) ??
        (auth?.user?.email as unknown as string);

    const form = useForm();

    return (
        <AppLayout
            breadcrumbs={[{ title: 'Google', href: '/settings/google' }]}
        >
            <Head title="Google" />
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Connect your Google account to send emails from this app
                        as you.
                    </p>
                                ...
                                <div>
                                    <Dialog>
                                        ...
                                        <DialogContent>
                                            ...
                                            <DialogDescription>
                                                Disconnecting your Google
                                                account will remove stored
                                                tokens and prevent this app from
