...
class SalesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Users are seeded by DatabaseSeeder

        // Insert events
        // Ensure every event row contains the exact same keys (MySQL requires a consistent column list for multi-row inserts)
        DB::table('events')->insert([
            [
                ...
                'responsible_user_id' => '00000000000000000000000001',
            ...
            [
                ...
                'quantity_with_card' => null,
                'quantity_without_card' => null,
                'responsible_user_id' => '00000000000000000000000002',
                'notes' => null,
                'variable_amount' => '0',
        ...
        DB::table('mails')->insert([
            [
                'id' => '00000000000000000000000409',
                'event_id' => '00000000000000000000000020',
                'user_id' => '00000000000000000000000001',
                'recipient_email' => 'danieljaurell@gmail.com',
                'subject' => 'Your ticket information',
                'body' => '<div style="font-family: \"Segoe UI\", Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background-color: #fdfcf9; border: 1px solid #d4c5a9;">...TRUNCATED FOR SEED...</div>',
                'success' => 1,
                'error_message' => null,
                'metadata' => json_encode(['email' => 'danieljaurell@gmail.com', 'subject' => 'Your ticket information', 'event_id' => 10]),
                'created_at' => '2025-12-24 09:34:38',
                'updated_at' => '2025-12-24 09:34:39',
            ],
            [
                'id' => '00000000000000000000000410',
                'event_id' => '00000000000000000000000020',
                'user_id' => '00000000000000000000000001',
                'recipient_email' => 'danieljaurell@gmail.com',
                'subject' => 'Your ticket information',
                ...
                'error_message' => null,
                'metadata' => json_encode(['email' => 'danieljaurell@gmail.com', 'subject' => 'Your ticket information', 'event_id' => 10]),
                'created_at' => '2025-12-24 09:34:45',
                'updated_at' => '2025-12-24 09:34:46',
            ],
        ]);
        ...
        DB::table('office_shifts')->insert([
            [
                'id' => '00000000000000000000000627',
                'started_by' => '00000000000000000000000001',
        ...
        // Insert products (must come before office_shift_sales because of foreign key constraints)
        DB::table('products')->insert([
            ['id' => '00000000000000000000000100', 'name' => 'ESNcard', 'description' => 'Membership card', 'price' => '15.00', 'quantity' => '-1', 'variable_amount' => '0', 'type' => 'product', 'created_at' => '2025-12-23 15:24:59', 'updated_at' => '2025-12-23 23:41:16'],
        ]);

        // Insert office shift sales
        DB::table('office_shift_sales')->insert([
            [
                'id' => '00000000000000000000000746',
                'office_shift_id' => '00000000000000000000000627',
                'product_id' => '00000000000000000000000100',
                'event_id' => null,
                'method' => 'card',
                'amount' => '15.00',
            ...
            [
                'id' => '00000000000000000000000756',
                'office_shift_id' => '00000000000000000000000628',
                'product_id' => null,
                'event_id' => '00000000000000000000000020',
                'method' => 'cash',
                'amount' => '25.00',
        ...
        DB::table('office_shift_workers')->insert([
            ['id' => '00000000000000000000000847', 'office_shift_id' => '00000000000000000000000627', 'user_id' => '00000000000000000000000001', 'role' => 'IT Manager', 'created_at' => '2025-12-23 23:50:32', 'updated_at' => '2025-12-23 23:50:32'],
            ['id' => '00000000000000000000000850', 'office_shift_id' => '00000000000000000000000627', 'user_id' => '00000000000000000000000003', 'role' => 'Marketing Manager', 'created_at' => '2025-12-24 00:47:10', 'updated_at' => '2025-12-24 00:47:10'],
            ['id' => '00000000000000000000000851', 'office_shift_id' => '00000000000000000000000627', 'user_id' => '00000000000000000000000004', 'role' => 'Finance Manager', 'created_at' => '2025-12-24 00:53:47', 'updated_at' => '2025-12-24 00:53:47'],
            ['id' => '00000000000000000000000852', 'office_shift_id' => '00000000000000000000000628', 'user_id' => '00000000000000000000000001', 'role' => 'IT Manager', 'created_at' => '2025-12-24 00:59:18', 'updated_at' => '2025-12-24 00:59:18'],
            ['id' => '00000000000000000000000853', 'office_shift_id' => '00000000000000000000000628', 'user_id' => '00000000000000000000000004', 'role' => 'Finance Manager', 'created_at' => '2025-12-24 00:59:23', 'updated_at' => '2025-12-24 00:59:23'],
        ]);

        // Insert tickets
        DB::table('tickets')->insert([
            ['id' => '00000000000000000000000511', 'event_id' => '00000000000000000000000020', 'user_id' => '00000000000000000000000001', 'ticket_code' => 'Horse-Riding-in-Sint-Joris-Wert_31-12-2025_to_Daniel-Meyer-Pepito_via_danieljaurell@gmail.com_7NIqlAth', 'first_name' => 'Daniel', 'last_name' => 'Meyer Pepito', 'email' => 'danieljaurell@gmail.com', 'unique_trait' => '7NIqlAth', 'scan_count' => 0, 'scan_details' => null, 'metadata' => json_encode(['email' => 'danieljaurell@gmail.com', 'last_name' => 'Meyer Pepito', 'event_date' => '2025-12-31 00:00:00', 'event_name' => 'Horse Riding in Sint Joris Wert', 'first_name' => 'Daniel']), 'scanned_at' => null, 'created_at' => '2025-12-24 09:34:31', 'updated_at' => '2025-12-24 09:34:31'],
            ['id' => '00000000000000000000000512', 'event_id' => '00000000000000000000000020', 'user_id' => '00000000000000000000000001', 'ticket_code' => 'Horse-Riding-in-Sint-Joris-Wert_31-12-2025_to_Pippi-longstocking_via_danieljaurell@gmail.com_XGbzULB4', 'first_name' => 'Pippi', 'last_name' => 'longstocking', 'email' => 'danieljaurell@gmail.com', 'unique_trait' => 'XGbzULB4', 'scan_count' => 4, 'scan_details' => '[{"user_id": 1, "timestamp": "2025-12-24 09:35:46", "user_email": "it@esnleuven.be"}, {"user_id": 1, "timestamp": "2025-12-24 09:35:51", "user_email": "it@esnleuven.be"}, {"user_id": 1, "timestamp": "2025-12-24 09:35:57", "user_email": "it@esnleuven.be"}, {"user_id": 1, "timestamp": "2025-12-24 09:36:05", "user_email": "it@esnleuven.be"}]', 'metadata' => json_encode(['email' => 'danieljaurell@gmail.com', 'last_name' => 'longstocking', 'event_date' => '2025-12-31 00:00:00', 'event_name' => 'Horse Riding in Sint Joris Wert', 'first_name' => 'Pippi']), 'scanned_at' => '2025-12-24 09:35:46', 'created_at' => '2025-12-24 09:34:31', 'updated_at' => '2025-12-24 09:36:05'],
        ]);
    }
}
