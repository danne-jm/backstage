    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            [
                ...
                'remember_token' => 'pOIUXDTPdj47pODkSPq1hgW6qnQsM06yMNyoNpadsRVtOlCEbLrMsNG8k6Xa',
            ...
            [
                ...
                'permissions' => '["admin", "view_dashboard", "manage_users", "manage_events", "manage_tickets", "manage_inventory", "manage_sales", "scan_tickets", "view_reports"]',
                'pinned' => '[{"href": "https://mail.google.com/", "icon": "Mail", "title": "Gmail"}]',
                'role' => 'President',
            ...
            [
                ...
                'email_verified_at' => null,
                'password_hash' => '$2y$12$examplehashforuser3xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
                'remember_token' => null,
                'gmail_refresh_token' => null,
                'gmail_provider_id' => null,
                'gmail_provider_email' => null,
                ...
                'created_at' => '2025-12-24 00:47:10',
                'updated_at' => '2025-12-24 00:47:10',
            ],
            [
                'id' => 4,
                'first_name' => 'Finance',
                ...
                'email_verified_at' => null,
                'password_hash' => '$2y$12$examplehashforuser4xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
                'remember_token' => null,
                'gmail_refresh_token' => null,
                'gmail_provider_id' => null,
                'gmail_provider_email' => null,
                'permissions' => '["view_dashboard", "manage_finances"]',
                'pinned' => '[]',
                'role' => 'Finance Manager',
                'created_at' => '2025-12-24 00:53:47',
                'updated_at' => '2025-12-24 00:53:47',
            ],
            // Additional users (3..12) omitted for brevity in seeder but can be added similarly if needed
        ]);
        ...
        DB::table('products')->insert([
            ['id' => 1, 'name' => 'ESNcard', 'description' => 'Membership card', 'price' => '15.00', 'quantity' => '-1', 'variable_amount' => '0', 'type' => 'product', 'created_at' => '2025-12-23 15:24:59', 'updated_at' => '2025-12-23 23:41:16'],
        ]);
